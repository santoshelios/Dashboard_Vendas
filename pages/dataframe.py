...
from utils import convert_csv,mensgem_sucesso

# Criando Página == Dataframe
st.title('Dataset de Vendas')

# Opção para seleção de Colunas
...
# Criando Query para manipular as informações (Filtros)
query = '''
...
# Mostrando a quantidade de colunas filtradas e linhas
